...
blocks.append("text").attr("class","tip").attr("transform",function(b){var x1=_this.scale(b.start),x2=_this.scale(b.stop),x=x1+(x2-x1)/2,y=(_this._BLOCK_HEIGHT+_this._PAD)*(b.y+1)+_this._PAD;return"translate("+x+", "+y+") rotate(-45)"}).attr("text-anchor","right").text(function(b){return b.start+" - "+b.stop});return track}/**
...
ticks.push(y+h/2)}// draw the y-axis
