...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor}}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function")}}var Synteny=function(){_createClass(Synteny,[{key:"_longestString",/**
    ...
    */value:function _longestString(text){var dummy=this.viewer.append("g"),max=0;dummy.selectAll(".dummyText").data(text).enter().append("text").text(function(s){return s}).each(function(s,i){var l=this.getComputedTextLength();if(l>max)max=l;this.remove()});dummy.remove();return max}/**
...
this.viewer=d3.select("#"+id).append("svg").attr("width",w).attr("height",this._PAD);// compute the space required for chromosome names
...
x1,y1,x1+ptr,middle,x1,y2]}).style("fill",c).style("cursor","pointer").on("mouseover",function(b){}).on("mouseout",function(b){}).on("click",this.options.blockClick);return track}/**
...
return this.viewer.append("g").attr("class","axis").call(yAxis).selectAll("text").style("font-weight",function(y,i){if(i==0)return"bold";return"normal"}).style("cursor","pointer").on("mouseover",function(y,i){}).on("mouseout",function(y,i){}).on("click",this.options.nameClick)}/** Draws the viewer. */},{key:"_draw",value:function _draw(){// draw the x-axis
