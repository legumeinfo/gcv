...
import * as globalPlotsActions from '@gcv/gene/store/actions/global-plots.actions';
import * as localPlotsActions from '@gcv/gene/store/actions/local-plots.actions';
import * as fromRoot from '@gcv/gene/store/reducers';
// app
import { Gene, Group, MicroTracks } from '@gcv/gene/models';
