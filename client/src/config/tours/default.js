var defaultTour = (function () {
  ...
  var tour = new Tour({
    ...
    steps: [
      ...
      {
        path: "/search/lis/phavu.Phvul.002G085200?bintermediate=10&bmask=10&bmatched=20&intermediate=5&matched=4&neighbors=10&sources=lis&algorithm=repeat&gap=-1&match=10&mismatch=-1&score=30&threshold=25&order=chromosome&regexp=",
        title: "Search View",
