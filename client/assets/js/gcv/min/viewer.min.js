...
var track=this.viewer.append('g').attr('data-micro-track',i.toString()).attr('data-chromosome',t.chromosome_name).attr('data-genus-species',t.genus+' '+t.species),neighbors=[];// add the lines
