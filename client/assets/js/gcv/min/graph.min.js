...
_this10.emissionProbabilities[o]=p});return _this10}//addPath(pId, o) {
//  super.addPath(pId);
//  this.counts[o]       += 1;
...
//  }
//}
return _class11}(Graph.MSAHMM.State);Graph.viterbi=function(hmm,seq){var probabilities={},pointers={};for(var id in hmm.nodes){if(hmm.nodes.hasOwnProperty(id)){probabilities[id]={};pointers[id]={}}}};/**
