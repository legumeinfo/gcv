...
if(path1.probability>=path2.probability){console.log("forward");console.log(seq1);console.log(path1);Graph.MSAHMM.embedPath(hmm,i,path1,seq1)}else{console.log("reverse");console.log(seq2);console.log(path2);Graph.MSAHMM.embedPath(hmm,i,path2,seq2)}// c) if necessary, perform surgery on the graph
