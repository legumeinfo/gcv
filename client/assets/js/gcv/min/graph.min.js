...
return fr!==null?findFRs(fr,minsup,minsize,0):[]};Graph.MSAHMM=(_temp3=_class8=function(_Graph$Directed){_inherits(_class8,_Graph$Directed);function _class8(numColumns,characters,edgeDelimiter){_classCallCheck(this,_class8);var _this8=_possibleConstructorReturn(this,(_class8.__proto__||Object.getPrototypeOf(_class8)).call(this,edgeDelimiter));_this8.numColumns=numColumns;_this8.numCharacters=characters.size;_this8.constructModel(characters);return _this8}_createClass(_class8,[{key:"constructModel",value:function constructModel(characters){// add nodes
this.addNode("s");for(var i=0;i<this.numColumns;i++){var id="m"+i,m=new Graph.MSAHMM.MatchState(characters);this.addNode(id,m);id="i"+i;this.addNode(id,new Graph.MSAHMM.InsertState);id="d"+i;this.addNode(id,new Graph.MSAHMM.State)}this.addNode("i"+this.numColumns,new Graph.MSAHMM.InsertState);this.addNode("e");// add edges
this.addEdge("s","m0",1);this.addEdge("s","i0",0);this.addEdge("s","d0",0);for(var i=0;i<this.numColumns-1;i++){this.addEdge("m"+i,"m"+(i+1),1);this.addEdge("m"+i,"i"+(i+1),0);this.addEdge("m"+i,"d"+(i+1),0);this.addEdge("i"+i,"i"+i,0);this.addEdge("i"+i,"m"+i,0);this.addEdge("i"+i,"d"+i,0);this.addEdge("d"+i,"d"+(i+1),0);this.addEdge("d"+i,"m"+(i+1),0);this.addEdge("d"+i,"i"+(i+1),0)}this.addEdge("m"+(this.numColumns-1),"i"+this.numColumns,0);this.addEdge("m"+(this.numColumns-1),"e",1);this.addEdge("i"+this.numColumns,"i"+this.numColumns,0);this.addEdge("i"+this.numColumns,"e",0);this.addEdge("d"+(this.numColumns-1),"i"+this.numColumns,0);this.addEdge("d"+(this.numColumns-1),"e",0)}}]);return _class8}(Graph.Directed),_class8.State=function(){function _class9(){_classCallCheck(this,_class9);this.paths=new Set}_createClass(_class9,[{key:"addPath",value:function addPath(pId){this.paths.add(pId)}}]);return _class9}(),_temp3);Graph.MSAHMM.InsertState=function(_Graph$MSAHMM$State){_inherits(_class10,_Graph$MSAHMM$State);function _class10(){_classCallCheck(this,_class10);var _this9=_possibleConstructorReturn(this,(_class10.__proto__||Object.getPrototypeOf(_class10)).call(this));_this9.insertions={};return _this9}_createClass(_class10,[{key:"addPath",value:function addPath(pId,o){_get(_class10.prototype.__proto__||Object.getPrototypeOf(_class10.prototype),"addPath",this).call(this,pId);if(!this.insertions.hasOwnProperty(pId)){this.insertions[pId]=[]}this.insertions[pId].put(o)}}]);return _class10}(Graph.MSAHMM.State);Graph.MSAHMM.MatchState=function(_Graph$MSAHMM$State2){_inherits(_class11,_Graph$MSAHMM$State2);function _class11(characters){_classCallCheck(this,_class11);var _this10=_possibleConstructorReturn(this,(_class11.__proto__||Object.getPrototypeOf(_class11)).call(this));_this10.emissions={};_this10.counts={};_this10.numObservations=characters.size;var p=1/_this10.numObservations;characters.forEach(function(o){_this10.emissions[o]=p;_this10.counts[o]=1;// pseudo-count of for computing emissions
});return _this10}_createClass(_class11,[{key:"addPath",value:function addPath(pId,o){_get(_class11.prototype.__proto__||Object.getPrototypeOf(_class11.prototype),"addPath",this).call(this,pId);this.counts[o]+=1;this.numObservations+=1;for(var o in this.emmisions){if(this.emmisions.hasOwnProperty(o)){var p=this.counts[o]/this.numObservations;this.emmisions[o]=p}}}}]);return _class11}(Graph.MSAHMM.State);/**
  * An HMM based MSA algorithm.
  * @param {object} tracks - groups attribute of GCV track data.
  * @return {int} - The computed score.
  */Graph.msa=function(groups){var embedAlignmentPath=function embedAlignmentPath(hmm,pId,states,observations){for(var i=0;i<states.length;i++){var n=hmm.getNode(states[i]).attr;if(n instanceof Graph.hmmInsert||n instanceof Graph.hmmMatch){n.addPath(pId,observations[i])}else{n.addPath(pId)}}};var performSurgery=function performSurgery(hmm){};// 1) construct the graph from the first track
