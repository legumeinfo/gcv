...
value:function getEdgeId(u,v){return u+this.ed+v}},{key:"addEdge",value:function addEdge(u,v,attr){var e=this.getEdgeId(u,v);if(!this.edges.hasOwnProperty(e)){this.nodes[u].outNeighbors.add(v);this.nodes[v].inNeighbors.add(u);this.edges[e]=attr}}},{key:"updateEdge",value:function updateEdge(u,v,attr){var e=this.getEdgeId(u,v);if(this.edges.hasOwnProperty(e)){this.edges[e]=attr}}},{key:"removeEdge",value:function removeEdge(u,v){var e=this.getEdgeId(u,v);if(this.edges.hasOwnProperty(e)){delete this.edges[e];this.nodes[u].outNeighbors.delete(v);this.nodes[v].inNeighbors.delete(u)}}},{key:"getEdge",value:function getEdge(u,v){var e=this.getEdgeId(u,v);if(this.edges.hasOwnProperty(e)){return this.edges[e]}return null}}]);return _class3}(Graph.Graph),_class3.Node=function(_Graph$Node){_inherits(_class4,_Graph$Node);function _class4(attr){_classCallCheck(this,_class4);var _this2=_possibleConstructorReturn(this,(_class4.__proto__||Object.getPrototypeOf(_class4)).call(this,att));_this2.inNeighbors=new Set;_this2.outNeighbors=new Set;return _this2}return _class4}(Graph.Node),_temp);Graph.Undirected=(_temp2=_class5=function(_Graph$Graph2){_inherits(_class5,_Graph$Graph2);function _class5(edgeDelimiter){_classCallCheck(this,_class5);return _possibleConstructorReturn(this,(_class5.__proto__||Object.getPrototypeOf(_class5)).call(this,edgeDelimiter))}_createClass(_class5,[{key:"removeNodeEdges",// primitive operations
...
return fr!==null?findFRs(fr,minsup,minsize,0):[]};Graph.MSAHMM=(_temp3=_class8=function(_Graph$Directed){_inherits(_class8,_Graph$Directed);function _class8(size,observations,edgeDelimiter){_classCallCheck(this,_class8);var _this7=_possibleConstructorReturn(this,(_class8.__proto__||Object.getPrototypeOf(_class8)).call(this,edgeDelimiter));_this7.size=size;constructModel(observations);return _this7}_createClass(_class8,[{key:"constructModel",value:function constructModel(observations){// add nodes
hmm.addNode("s");for(var i=0;i<l;i++){var id="m"+i,m=new Graph.hmmMatch(families);hmm.addNode(id,m);id="i"+i;hmm.addNode(id,new Graph.hmmInsert);id="d"+i;hmm.addNode(id,new Graph.hmmNode)}hmm.addNode("i"+l,new Graph.hmmInsert);hmm.addNode("e");// add edges
g.addEdge("s","m0",1);g.addEdge("s","i0",0);g.addEdge("s","d0",0);for(var i=0;i<l-1;i++){g.addEdge("m"+i,"m"+(i+1),1);g.addEdge("m"+i,"i"+(i+1),0);g.addEdge("m"+i,"d"+(i+1),0);g.addEdge("i"+i,"i"+i,0);g.addEdge("i"+i,"m"+i,0);g.addEdge("i"+i,"d"+i,0);g.addEdge("d"+i,"d"+(i+1),0);g.addEdge("d"+i,"m"+(i+1),0);g.addEdge("d"+i,"i"+(i+1),0)}g.addEdge("m"+l-1,"i"+l,0);g.addEdge("m"+l-1,"e",1);g.addEdge("i"+l,"i"+l,0);g.addEdge("i"+l,"e",0);g.addEdge("d"+l-1,"i"+l,0);g.addEdge("d"+l-1,"e",0)}}]);return _class8}(Graph.Directed),_class8.State=function(){function _class9(){_classCallCheck(this,_class9);this.paths=new Set}_createClass(_class9,[{key:"addPath",value:function addPath(pId){this.paths.add(pId)}}]);return _class9}(),_temp3);Graph.MSAHMM.InsertState=function(_Graph$MSAHMM$State){_inherits(_class10,_Graph$MSAHMM$State);function _class10(){_classCallCheck(this,_class10);var _this8=_possibleConstructorReturn(this,(_class10.__proto__||Object.getPrototypeOf(_class10)).call(this));_this8.insertions={};return _this8}_createClass(_class10,[{key:"addPath",value:function addPath(pId,o){_get(_class10.prototype.__proto__||Object.getPrototypeOf(_class10.prototype),"addPath",this).call(this,pId);if(!this.insertions.hasOwnProperty(pId)){this.insertions[pId]=[]}this.insertions[pId].put(o)}}]);return _class10}(Graph.MSAHMM.State);Graph.MSAHMM.MatchState=function(_Graph$MSAHMM$State2){_inherits(_class11,_Graph$MSAHMM$State2);function _class11(observations){_classCallCheck(this,_class11);var _this9=_possibleConstructorReturn(this,(_class11.__proto__||Object.getPrototypeOf(_class11)).call(this));_this9.emissions={};_this9.counts={};_this9.numObservations=observations.size();var p=1/numObservations;observations.forEach(function(o){_this9.emissions[o]=p;_this9.counts[o]=1;// pseudo-count of for computing emissions
});return _this9}_createClass(_class11,[{key:"addPath",value:function addPath(pId,o){_get(_class11.prototype.__proto__||Object.getPrototypeOf(_class11.prototype),"addPath",this).call(this,pId);this.counts[o]+=1;this.numObservations+=1;for(var o in this.emmisions){if(this.emmisions.hasOwnProperty(o)){var p=this.counts[o]/this.numObservations;this.emmisions[o]=p}}}}]);return _class11}(Graph.MSAHMM.State);/**
  ...
  */Graph.msa=function(tracks,alignmentF){var embedAlignmentPath=function embedAlignmentPath(hmm,pId,states,observations){for(var i=0;i<states.length;i++){var n=hmm.getNode(states[i]).attr;if(n instanceof Graph.hmmInsert||n instanceof Graph.hmmMatch){n.addPath(pId,observations[i])}else{n.addPath(pId)}}};var performSurgery=function performSurgery(hmm){};// 1) construct the graph from the first track
var l=tracks.groups[0].genes.length,families=new Set;for(var i=0;i<tracks.groups.length;i++){for(var j=0;j<tracks.groups[i].genes.length;j++){families.add(tracks.groups[i].genes[j].family)}}var hmm=new Graph.Directed(l,families);// 2) iteratively add each remaining track to the alignment
for(var i=1;i<tracks.groups.length;i++){// a) align to the consensus
