...
export function isServer(instance: any): instance is Server {
  ...
  return (
    ...
    server.chromosome !== undefined &&
    isRequest(server.chromosome) &&
    server.microSearch !== undefined &&
    isRequest(server.microSearch) &&
    server.blocks !== undefined &&
    isRequest(server.blocks) &&
    server.search !== undefined &&
    isRequest(server.search) &&
    server.region !== undefined &&
    isRequest(server.region) &&
