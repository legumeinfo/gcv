...
import { getSelectedMicroTracksForCluster } from '@gcv/gene/store/selectors/micro-tracks/clustered-and-aligned-micro-tracks.selector';
...
export const getSelectedChromosomesForCluster = (id: number) =>
  createSelectorFactory(memoizeArray)(
    ...
    (chromosomes: Track[], tracks: (Track & ClusterMixin)[]): Track[] => {
      ...
      const clusterChromosomes = chromosomes.filter((c) => {
