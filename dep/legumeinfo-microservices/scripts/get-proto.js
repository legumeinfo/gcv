...
const microservices = [
  {name: 'chromosome', version: '1.1.3'},
  {name: 'chromosome_region', version: '1.1.3'},
  {name: 'chromosome_search', version: '1.1.3'},
  {name: 'genes', version: '1.1.3'},
  {name: 'gene_search', version: '1.1.3'},
  {name: 'macro_synteny_blocks', version: '1.3.3'},
  {name: 'micro_synteny_search', version: '1.1.3'},
  {name: 'pairwise_macro_synteny_blocks', version: '1.3.3'},
  {name: 'search', version: '1.1.3'},
];
